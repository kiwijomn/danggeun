package com.umc.danggeun.config;
...
public enum BaseResponseStatus {
    ...
    POST_USERS_EMPTY_ADDRESS(false, 2011, "동네를 설정해주세요."),
    POST_USERS_EMPTY_PHONENUMBER(false, 2012, "전화번호를 입력해주세요."),
    POST_USERS_EMPTY_NICKNAME(false, 2013, "별명을 입력해주세요."),
    POST_USERS_DUPLICATE_PHONENUMBER(false, 2014, "이미 등록된 전화번호입니다."),
    ...
    POST_USERS_INVALID_USER(false, 2020, "회원가입을 해주세요."),
    ...
    GET_EXSIT_KEYWORD(false, 2029, "키워드 값과 카테고리 값이 동시에 입력 되었습니다. 하나만 입력해주세요."),
    ...
    //[DELETE]  /address/:townId
    DELETE_ADDRESS_EXIST_ERROR(false, 2041, "삭제할 동네가 존재하지 않습니다."),
    ...
    DATABASE_ERROR2(false, 4222, "상태확인쓰"),
    DATABASE_ERROR3(false, 4333, "상태확인쓰가 바갈쓰"),
